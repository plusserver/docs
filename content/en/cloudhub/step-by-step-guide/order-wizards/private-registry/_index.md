...
Welcome to the [Private Registry order wizard](https://cloudhub.plusserver.com/cloud-services/private-registry/order). Here it is described which configuration options are available and how a new Private Registry can be ordered.
