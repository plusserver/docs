...
![Beispiel Level 1](./img/structure-product-dashboard-1.png)
...
![Beispiel Level 2](./img/structure-product-dashboard-2.png)
...
![Beispiel Level 3](./img/structure-product-dashboard-3.png)

Sonstiges: Rollen und Rechte für das Dashboard werden im Bereich "User Management" verwaltet.\
![Beispiel Rollen-und-Rechte-Verwaltung für das Produkt-Dashboard](./img/roles-and-rights-management.png)
...
![Level 1: Gebuchte Produkte werden in Kategorien (Tabs) und Typen (Kacheln) angezeigt](./img/lvl-1-booked-products.png)
...
![Level 1: Quick Links zu weiteren Produkten, Informationen und Dokumentationen](./img/lvl-1-quick-links-2.png)
...
![Level 2: Beispiel eines pluscloud-VMware-Produktes](./img/lvl-2-example-pcv-product.png)
![Level 2: Beispiel eines Datenbank-Produktes](./img/lvl-2-example-db-product.png)
...
![Level 3: Tab 1 - Beispiel pluscloud open](./img/lvl-3-example-pco.png)
...
![Level 3: Anpassungen im Bearbeitungsmodus - 1](./img/lvl-3-adjustments-in-edit-mode-1.png)
![Level 3: Anpassungen im Bearbeitungsmodus - 2](./img/lvl-3-adjustments-in-edit-mode-2.png)

Da jede Änderung mit Auswirkungen auf Ihre Abrechnung verbunden ist, werden Sie vor der endgültigen Bestätigung noch einmal transparent über die Kostenänderung informiert.
![Level 3: Beispiel eines Info-Pop-upps für die Kostenänderungen](./img/lvl-3-info-pop-up-cost-change.png)
...
![Level 3: Fortschritt der Anpassung](./img/lvl-3-progress-of-customization.png)

Zudem dokumentieren wir Ihre Anpassung in einem Ticket, über das Sie per E-Mail benachrichtigt werden. Dieses Ticket finden Sie auch im Tab "Tickets" sowie in der Ticketübersicht im Support-Bereich.
...
![Level 3: Löschen der Read Replica (nur für Datenbanken)](./img/lvl-3-db-delete-read-replica.png)
...
![Level 3: Kündigungsticket](./img/lvl-3-cancellation-ticket.png)
...
![Rollen und Berechtigungen: Beispiel für die Erstellung einer Rolle für das Dashboard](./img/rnr-example-create-role-for-dashboard.png)
