---
title: "Admin-Nutzer kann weitere Nutzer per E-Mail einladen"
linkTitle: "Admin-Nutzer kann weitere Nutzer per E-Mail einladen"
type: "docs"
weight: 2
description: >
    Informationen zum Einladen von weiteren Nutzern per E-Mail
---
...
3. Admin sieht ein Pop-up-Fenster, wo er die E-Mail-Adresse des Nutzers eingeben kann, den er einladen will. (E-Mail-Adresse ist Pflichtfeld).
...
Sobald die Einladung erfolgreich angenomen wurde, taucht der hinzugefügte Nutzer in der User-Management-Tabelle auf.

### Weitere Funktionen für den Admin im Einladungskontext
...
2. Admin kann über die Einladungstabelle Einladungen erneut versenden (Symbol Kreis-Pfeil)

![User Management - Einladungen erneut versenden ](img/usr-mngmt-resend-invitation.png)

3. Admin kann über die Einladungstabelle Einladungen löschen (Symbol Mülltonne). Die Löschung muss immer bestätigt werden.
...
## Einladung aus der Perspektive des eingeladenen Nutzers
...
3. Nach erfolgreicher Eingabe der Daten / erfolgreichem Login kommen die Nutzer in den CloudHub.
4. Sollten die jeweiligen Nutzer noch keine Rechte vom Admin erhalten haben, haben sie aus Sicherheitsgründen einen eingeschränkten Zugriff auf den CloudHub
    ...
    3. Sobald der Nutzer seine Rechte erhalten hat, werden ihm auch beim nächsten Login in den CloudHub entsprechend die Schritte in der Welcome-Tour angezeigt, für die Bereiche, auf die der Nutzer dann Zugriff hat.
...
Auswirkungen der Aufhebung des Zugriffs auf eine Kundennummer für den Nutzer:
