...
Willkommen zum [Bestellformular des Managed Cachings](https://cloudhub.plusserver.com/cloud-services/managed-caching/order). Hier wird beschrieben, welche Konfigurationsmöglichkeiten es gibt und wie ein neues Managed Cachings bestellt werden kann.
